...
var resizePizzas = function(size) {
  ...
  //modified this function to only return the % of the div the element should take up.

  //DD - Removed the calculation to get pixel size and instead will return the result of the switch statement.
  //makes this function simpler and also simplifies the changePizzaSlices function.
...
//Move the select of the randomPizzas div outside the loop at reviewer suggestion.
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  //get viewport height and use to dynamically determine number of moving pizzas needed.
  //It is a good idea but it is a problem if I start with a small viewport and then resize
  //the window larger.
